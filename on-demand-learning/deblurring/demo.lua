...
for i = 1, opt.batchSize do
    ...
    local gk = util.GaussianKernel(kernelSize, sigma_X, sigma_Y)

    for j = 1, 3 do
        local image_blurred = util.GaussianSmoothing(corrupted_image[{{i},{j},{},{}}]:squeeze(), gk)
        --cv.GaussianBlur{corrupted_image[{{i},{j},{},{}}]:squeeze(),ksize=kernelSize,sigmaX=sigma_X,sigmaY=sigma_Y}
