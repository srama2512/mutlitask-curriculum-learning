...
opt = {
   ...
   nThreads = 8,           -- # of data loading threads to use
   ...
   save_path='checkpoint/'   -- path to save the models
}
...
for epoch = 1, opt.niter do
   ...
   if epoch % 20 == 0 or epoch == 1 then
      util.save(opt.save_path .. opt.name .. '_' .. epoch + opt.base .. '_net_G.t7', netG, opt.gpu)
   end
