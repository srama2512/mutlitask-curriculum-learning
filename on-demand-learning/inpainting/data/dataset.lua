...
function dataset:__init(...)
   ...
   --print('Enters finding image path names')
...
function dataset:getByClass(class)
   ...
   --print('===> Intermediate: ')
   --print(self.classListSample[class][index])
   --print(self.imagePath)
   --print(self.imagePath[self.classListSample[class][index]])
   local imgpath = ffi.string(torch.data(self.imagePath[self.classListSample[class][index]]))
   --print('===> Got imgpath: '..imgpath)
